...
public class DriverSelectColumns implements Driver{
	...
	public DriverSelectColumns(TableList<HashTable> tables2) {
		this.tables = tables2;
	...
	public boolean valid(String query) {
		...
		if (!matcher.matches()) {
			...
			String[] wantedColumns = matcher.group(2).split(","); //get the matching group of all the column names
